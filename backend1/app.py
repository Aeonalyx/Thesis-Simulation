...
Wraps the scheduler_engine.py with REST endpoints for running simulations
"""

from flask import Flask, request, jsonify
from flask_cors import CORS
from scheduler_engine import SimulationEngine, COLLEGES, DOCUMENT_COMPLEXITY, COLLEGE_POPULATION
import json
